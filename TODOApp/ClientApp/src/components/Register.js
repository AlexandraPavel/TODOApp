...
export class Register extends Component {
	constructor(props) {
		...
		this.state = {
			firstname: {
				value: "",
				error: "Pune la dispoziție un prenume"
            },
            lastname: {
                value: "",
                error: "Pune la dispoziție numele de familie"
            },
			password: {
				value: "",
    ...
    loginToServer = function () {
        let loginParams = {
            fistname: this.state.firstname.value,
...
*/        /*postLogin(loginParams, this.setSubmissionSuccess, this.setSubmissionFail);   aici se adauga functia post*/
    }
					...
					<div className="leftContainer">
						<form onSubmit={this.handleSubmit} className="formFields">
							<div className="loginTitle">
								{this.state.displayResetBox ? "Resetează parola" : "Login to ToDo Helper"}
							</div>
